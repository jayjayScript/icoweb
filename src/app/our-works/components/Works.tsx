...
const Works = () => {
  ...
  const cardVariants = {
    ...
    hover: { y: -10, scale: 1.02, boxShadow: '0 20px 40px rgba(0,0,0,0.15)', transition: { duration: 0.3 } }
  }
          ...
          <div className=''>
            <div className='grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-8'>
              {Cards.map((card, index) => (
                <motion.div
                  key={index}
                  className="relative flex-shrink-0 flex-grow-0 min-w-0 w-full h-[480px] sm:h-[531px] md:h-[545px] lg:h-[559px] cursor-pointer shadow-[rgba(0,0,0,0.07)] shadow-[0_0_15px_#544BC215,0_4px_20px_#544BC220] rounded-2xl sm:rounded-3xl overflow-hidden"
