      ...
      <div className="relative">
        ...
        >
          <motion.button
            ...
            className="w-[40px] h-[40px] md:w-[46px] md:h-[46px] rounded-full bg-transparent bg-opacity-20 border border-white border-opacity-30 flex items-center justify-center cursor-pointer transition-all backdrop-blur-sm disabled:opacity-30 disabled:cursor-not-allowed"
            variants={buttonVariants as any}
            whileHover={!prevBtnDisabled ? "hover" : undefined}
            whileTap={!prevBtnDisabled ? "tap" : undefined}
          >
          ...
          <motion.button
            ...
            className="w-[40px] h-[40px] md:w-[46px] md:h-[46px] rounded-full bg-transparent bg-opacity-20 border border-white border-opacity-30 flex items-center justify-center cursor-pointer transition-all backdrop-blur-sm disabled:opacity-30 disabled:cursor-not-allowed"
            variants={buttonVariants as any}
            whileHover={!nextBtnDisabled ? "hover" : undefined}
            whileTap={!nextBtnDisabled ? "tap" : undefined}
          >
        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <motion.div 
            className="flex gap-4 sm:gap-5 md:gap-6 pl-4 sm:pl-6 md:pl-12 lg:pl-24"
            variants={containerVariants}
          >
              ...
              >
                ...
                >
                  <motion.div 
                    ...
                    variants={cardContentVariants as any}
                  >
