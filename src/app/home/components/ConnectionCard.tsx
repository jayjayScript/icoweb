...
const ConnectionCard = () => {
    return (
        <div>
            <div className='relative md:max-w-[85%] mx-auto mt-34'>
            ...
            `,
                    ...
                    <div className='relative z-50 top-8 md:top-18 px-8 py-6'>
                        ...
                        <p className='text-[#707070] text-[14px] md:text-[16px] font-medium text-center my-2 md:my-6 md:w-[40%] mx-auto'>From websites to apps, our team is ready to turn your ideas into high-performing digital products.</p>
